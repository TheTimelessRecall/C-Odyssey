...
void displayCompressed(SparseMatrix* m) {
    ...
    printf("\nCompressed Form:\n");
    printf("RowIdx: ");
    for (int k = 0; k < m->nonZeroCount; k++) printf("%d ", m->row_index[k]);
    printf("\nColIdx: ");
    for (int k = 0; k < m->nonZeroCount; k++) printf("%d ", m->col_index[k]);
    printf("\nValues: ");
    for (int k = 0; k < m->nonZeroCount; k++) printf("%d ", m->values[k]);
    printf("\n");
}
